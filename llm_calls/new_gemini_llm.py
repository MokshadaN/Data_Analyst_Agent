...
MODEL_CHAIN = [
    os.getenv("GEMINI_MODEL_PRIMARY", "gemini-3-pro-preview"),
    os.getenv("GEMINI_MODEL_FALLBACK", "gemini-2.5-flash"),
]

# Default for ad-hoc calls/tests (not critical once MODEL_CHAIN is set)
GEMINI_MODEL_DEFAULT = os.getenv("GEMINI_MODEL_DEFAULT", "gemini-3-pro-preview")

# Always use the same key from the environment as test_gemini_key.py
